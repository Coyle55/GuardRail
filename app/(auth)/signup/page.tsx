        ...
        <div style={{ background: 'var(--gr-card)', border: '1px solid var(--gr-border-md)', borderRadius: '20px', padding: '32px' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
            <div>
              ...
              <input id="name" type="text" className="gr-input" value={name} onChange={(e) => setName(e.target.value)} disabled={busy} required placeholder="Your name" />
            </div>
            <div>
            ...
            <div>
              ...
              <input id="password" type="password" className="gr-input" value={password} onChange={(e) => setPassword(e.target.value)} disabled={busy} required minLength={8} placeholder="Min. 8 characters" />
            </div>
